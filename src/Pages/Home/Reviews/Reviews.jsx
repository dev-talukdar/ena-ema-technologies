...
const Reviews = () => {
  ...
  const { data: reviews = [], refetch } = useQuery({
    queryKey: ["reviews"],
    queryFn: async () => {
      const res = await axios.get("https://ena-ema-server-47ior8utm-dev-talukdar.vercel.app/reviews")
      return res.data;
    }
  })
            ...
            >
              <div className='flex flex-col lg:flex-row gap-12 h-full w-full items-center justify-between lg:px-14 space-y-4 px-8'>
                ...
                <div className='w-full'>
                  <img src={review.photoUrl} alt="Client" className='w-92 h-96 rounded-2xl shadow-2xl' />
                </div>
                  ...
                  <div className='my-6'>
                    ...
                    <div className='text-left'>
                      ...
                      <p className='font-medium'>
                        {review.clientPosition} at <span className='text-orange-400 font-semibold'>{review.clientOrganization}</span>
                      </p>
                    </div>
