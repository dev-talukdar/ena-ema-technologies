...
const Contact = () => {
    ...
    const onSubmit = async (data) => {
        if (data.service === "Select Your Service") {
            ...
            const res = await axios.post("https://ena-ema-server-47ior8utm-dev-talukdar.vercel.app/clients-message", newMessage)
        ...
        <section className='flex items-center justify-center min-h-[calc(100vh-100px)]'>
            ...
            <div>
                ...
                <div className='flex gap-14 flex-col lg:flex-row items-center justify-center'>
                    ...
                    <div>
                        <h1 className="mt-8 mb-5 text-3xl font-bold brandFont text-center">Contact Our Support Team</h1>
                        <p className="mb-5 font-medium text-center">Fill in the below form to receive a detailed estimation. One of our friendly team member will be in touch soon</p>
                        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-4'>
                            ...
                            <select {...register("service")} className='inputField font-semibold'>
                                ...
                                <option value="Web Presence Solution">Web Presence Solution</option>
                                <option value="E-commerce Solution">E-commerce Solution</option>
                                <option value="Advanced Web Solution for Enterprise">Advanced Web Solution for Enterprise</option> 
                            </select>

                            <label className='font-bold brandFont'>Your Query<sup className='text-error'>*</sup></label>
                            <textarea rows="5" cols="10" placeholder='Your Message'
                                ...
                                className='inputField' /> 
                            {errors.message?.type === 'pattern' && (<span className='text-red-600 text-sm'>Message contain special character, please remove them to continue ! </span>)}
